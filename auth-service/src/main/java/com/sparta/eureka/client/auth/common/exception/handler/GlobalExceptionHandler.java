package com.sparta.eureka.client.auth.common.exception.handler;
...
import com.sparta.eureka.client.auth.common.exception.dto.ExceptionResponse;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<ExceptionResponse> handleRuntimeException(
    ...
    ExceptionCode exceptionCode = GlobalExceptionCode.INTERNAL_ERROR; // 내부 서버 오류 코드
  ...
  protected ResponseEntity<Object> handleMethodArgumentNotValid(
    ...
    ExceptionCode exceptionCode = GlobalExceptionCode.INVALID_INPUT; // 유효성 검사 실패 코드
  ...
  protected ResponseEntity<Object> handleHttpMessageNotReadable(
    ...
    HttpServletRequest servletRequest = ((ServletWebRequest) request).getRequest();
    ExceptionCode exceptionCode = GlobalExceptionCode.NOT_READABLE; // 요청 바디 읽기 실패 코드
  ...
  protected ResponseEntity<Object> handleHandlerMethodValidationException(
    ...
    HttpServletRequest servletRequest = ((ServletWebRequest) request).getRequest();
    ExceptionCode exceptionCode = GlobalExceptionCode.INVALID_REQUEST; // 요청 파라미터 검증 실패 코드
  ...
  public ResponseEntity<ExceptionResponse> handleAccessDeniedException(
    ...
    ExceptionCode exceptionCode = GlobalExceptionCode.FORBIDDEN; // 접근 금지 코드
    ExceptionResponse response = createErrorResponse(request, exceptionCode, null);
